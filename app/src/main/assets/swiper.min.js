            ...
            b.updatePagination = function() {
                if (b.params.pagination && b.paginationContainer && b.paginationContainer.length > 0) {
                    ...
                    if ("bullets" === b.params.paginationType) {
                    	//alert(b.snapGrid.length)
                        for (var a = b.params.loop ? Math.ceil((b.slides.length - 2 * b.loopedSlides) / b.params.slidesPerGroup) : b.snapGrid.length - 1, t = 0; a > t; t++)
