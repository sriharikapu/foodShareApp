...
public class FansAadpter extends FFBaseAdapter {
    public FansAadpter(Class viewHolderClass, int layoutId, List dataList, FFContext context) {
        super(viewHolderClass, layoutId, dataList, context);
    }

    public FansAadpter(Class viewHolderClass, int layoutId, FFContext context) {
        super(viewHolderClass, layoutId, context);
    }

    @Override
    public void setViewData(Object viewholder, int position, Object model) {
        if (viewholder != null && viewholder instanceof  FansActivty.RelationItemViewHolder) {
            FansActivty.RelationItemViewHolder  viewHolder = ( FansActivty.RelationItemViewHolder) viewholder;
