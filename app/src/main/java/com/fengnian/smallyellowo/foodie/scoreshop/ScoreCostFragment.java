 ...
 */
public class ScoreCostFragment extends BaseFragment {
    private RecyclerView mRecyclerView;
    public ScoreCostFragAdapter mAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ScoreCostFragAdapter(this);
    }
...
//        post(Constants.shareConstants().getNetHeaderAdress() + "/shopmall/queryUserScoreAllHistoryList.do", "",
    ...
    public static ScoreCostFragment newInstance() {
        ScoreCostFragment tabFragment = new ScoreCostFragment();
        return tabFragment;
    }
