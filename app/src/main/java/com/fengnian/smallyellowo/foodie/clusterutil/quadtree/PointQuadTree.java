...
package com.fengnian.smallyellowo.foodie.clusterutil.quadtree;
...
public class PointQuadTree<T extends PointQuadTree.Item> {
    ...
    /**
     * Remove the given item_image_gallery from the set.
     *
     * @return whether the item_image_gallery was removed.
     */
