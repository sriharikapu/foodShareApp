...
import com.fengnian.smallyellowo.foodie.clusterutil.projection.Bounds;
...
import com.fengnian.smallyellowo.foodie.clusterutil.quadtree.PointQuadTree;
 ...
 * 2. Create a cluster with the center of the item_image_gallery. <br>
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    public static final int MAX_DISTANCE_AT_ZOOM = 800; // essentially 100 dp.
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                if (clusterItems.size() == 1) {
                    // Only the current marker is in range. Just add the single item_image_gallery to the results.
               ...
               StaticCluster<T> cluster =
                ...
                for (QuadItem<T> clusterItem : clusterItems) {
                    ...
                    if (existingDistance != null) {
                        ...
                        // Move item_image_gallery to the closer cluster.
    ...
    private static class QuadItem<T extends ClusterItem> implements PointQuadTree.Item, Cluster<T> {
        ...
        private final com.fengnian.smallyellowo.foodie.clusterutil.projection.Point mPoint;
        ...
        @Override
        public com.fengnian.smallyellowo.foodie.clusterutil.projection.Point getPoint() {
            return mPoint;
        }
