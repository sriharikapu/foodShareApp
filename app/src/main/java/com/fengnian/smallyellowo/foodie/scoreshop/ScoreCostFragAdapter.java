 ...
 */
public class ScoreCostFragAdapter extends RecyclerView.Adapter<MyViewHolder> {
    private ScoreCostFragment mFragment;
    private List<SYNewPerPointsListModel> mAllList = new ArrayList<>();
    private int mLoadState;

    public ScoreCostFragAdapter(ScoreCostFragment fragment) {
        mFragment = fragment;
    }
    ...
    private void setEmptyView(boolean isEmpty, MyViewHolder holder) {
        ...
        if (isEmpty) {
            ...
            holder.emptyImageView.setImageResource(R.drawable.score_cost_empty_icon);
            ...
            holder.emptyImageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ((BaseActivity) (mFragment.getActivity())).startActivity(ScoreShopActivity.class, new IntentData());
                }
            });
        } else {
