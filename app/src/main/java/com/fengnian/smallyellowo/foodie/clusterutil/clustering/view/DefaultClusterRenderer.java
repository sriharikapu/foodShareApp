...
package com.fengnian.smallyellowo.foodie.clusterutil.clustering.view;
...
import com.fengnian.smallyellowo.foodie.clusterutil.projection.Point;
import com.fengnian.smallyellowo.foodie.clusterutil.projection.SphericalMercatorProjection;
import com.fengnian.smallyellowo.foodie.clusterutil.ui.IconGenerator;
import com.fengnian.smallyellowo.foodie.clusterutil.ui.SquareTextView;
...
import static com.fengnian.smallyellowo.foodie.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
//        mIconGenerator.setBackground(context.getDrawable(R.mipmap.shanghu_zuobiao));
...
//        return BUCKETS[BUCKETS.length - 1];
     ...
     */
//    protected void onBeforeClusterItemRendered(T item_image_gallery, MarkerOptions markerOptions) {
//
//    }
...
//            mColoredCircleBackground.getPaint().setColor(getColor(bucket));
            ...
            descriptor = BitmapDescriptorFactory.fromBitmap(mIconGenerator.makeIcon(bucket + ""));//getClusterText(bucket)
...
//                    onClusterItemRendered(item_image_gallery, marker);  //Called after the marker for a ClusterItem has been added to the map. 已经存在 也重新加载  单个mark
