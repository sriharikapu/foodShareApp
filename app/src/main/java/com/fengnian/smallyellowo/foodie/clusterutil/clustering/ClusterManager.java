...
package com.fengnian.smallyellowo.foodie.clusterutil.clustering;
...
import com.fengnian.smallyellowo.foodie.clusterutil.clustering.algo.Algorithm;
import com.fengnian.smallyellowo.foodie.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
import com.fengnian.smallyellowo.foodie.clusterutil.clustering.algo.PreCachingAlgorithmDecorator;
import com.fengnian.smallyellowo.foodie.clusterutil.clustering.view.ClusterRenderer;
...
public class ClusterManager<T extends ClusterItem> implements
    ...
    /**
     * Force a re-cluster. You may want to call this after adding new item_image_gallery(s).
     */
    public void cluster() {
