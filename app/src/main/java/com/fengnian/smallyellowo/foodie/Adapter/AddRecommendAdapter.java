...
import com.fengnian.smallyellowo.foodie.bean.publics.RecommendPeople;
...
public class AddRecommendAdapter extends BaseAdapter {

    private FFNetWork mNet;
    private FFContext mcontext;
    private List<RecommendPeople> addtolist;
  //  private List<SYUser> needtolist;
     public AddRecommendAdapter(FFContext context, List<RecommendPeople> addFriendsList){
    ...
    public View getView(final int pos, View view, ViewGroup viewGroup) {
        ...
        if(pos>=addtolist.size()){
            ...
            /*SYUser user=needtol ist.get(new_pos);
            ...
            holder.tv_is_attion.setText("已关注");
            holder.tv_is_attion.setBackgroundResource(R.drawable.is_attion_bg);
        }
