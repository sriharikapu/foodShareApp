...
public class WheelView extends View {
	...
	//*/
    private int[] SHADOWS_COLORS = new int[]{0xefEdEdEd,
            0xcfEdEdEd, 0x3fEdEdEd};
    ...
    // The number of first item_image_gallery in layout
    ...
    /**
     * Sets the current item_image_gallery. Does nothing when index is wrong.
     *
     * @param index    the item_image_gallery index
    ...
    /**
     * Sets the current item_image_gallery w/o animation. Does nothing when index is wrong.
     *
     * @param index the item_image_gallery index
     */
    ...
    /**
     * Tests if wheel is cyclic. That means before the 1st item_image_gallery there is shown the last one
     *
    ...
    /**
     * Returns height of wheel item_image_gallery
     *
     * @return the item_image_gallery height
     */
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.wheel_view_line));
        // 设置线宽
    ...
    /**
     * Creates item_image_gallery layouts if necessary
     */
    ...
    /**
     * Adds view for item_image_gallery to items layout
     *
     * @param index the item_image_gallery index
     * @param first the flag indicates if view should be first
     * @return true if corresponding item_image_gallery exists and is added
     */
     ...
     *
     * @param index the item_image_gallery index
     * @return true if item_image_gallery index is not out of bounds or the wheel is cyclic
     */
    ...
    /**
     * Returns view for specified item_image_gallery
     *
     * @param index the item_image_gallery index
     * @return item_image_gallery view or empty view if index is out of bounds
     */
