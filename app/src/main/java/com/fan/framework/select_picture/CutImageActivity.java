...
public class CutImageActivity extends BaseActivity<IntentData> implements OnTouchListener {
...
//				}
                ...
                final String path = FileUitl.getCacheFileDir()+"/"+System.currentTimeMillis()
                        + ".jpg";
                try {
//                    FileOutputStream fout = new FileOutputStream(path);
//                    bitmap.compress(Bitmap.CompressFormat.PNG, IMAGE_QUALITY, fout);
    ...
    public static void skipToForResult(Activity activity, String path,
                                       int intentCode) {
