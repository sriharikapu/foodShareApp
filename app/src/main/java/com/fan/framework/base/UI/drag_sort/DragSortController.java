...
/**
 * Class that starts and stops item_image_gallery drags on a {@link DragSortListView} based on
...
public class DragSortController extends SimpleFloatViewManager
    ...
    private int mDragInitMode = ON_LONG_PRESS;
     ...
     *
     * @param dslv         The DSLV instance
     * @param dragHandleId The resource id of the View that represents the drag handle in
     *                     a list item_image_gallery.
     */
    public DragSortController(DragSortListView dslv, int dragHandleId, int dragInitMode, int removeMode,
    ...
    /**
     * Enable/Disable list item_image_gallery sorting. Disabling is useful if only item_image_gallery
     * removal is desired. Prevents drags in the vertical direction.
     *
     * @param enabled Set <code>true</code> to enable list item_image_gallery sorting.
     */
    ...
    /**
     * Enable/Disable item_image_gallery removal without affecting remove mode.
     */
     ...
     * DragSortListView.
     *
     * @param position The list item_image_gallery position (includes headers).
    ...
    /**
     * Checks for the touch of an item_image_gallery's drag handle (specified by
     * {@link #setDragHandleId(int)}), and returns that item_image_gallery's position if a
     * drag handle touch was detected.
     *
     * @param ev The ACTION_DOWN MotionEvent.
     * @return The list position of the item_image_gallery whose drag handle was touched; MISS
     * if unsuccessful.
     */
    ...
    public int viewIdHitPosition(MotionEvent ev, int id) {
        ...
        // item_image_gallery that's not a header or footer.
    ...
    public void onLongPress(MotionEvent e) {
        ...
        if (mHitPos != MISS && mDragInitMode == ON_LONG_PRESS && (mDslv.isHas() ? mHitPos != 0 : true)) {
