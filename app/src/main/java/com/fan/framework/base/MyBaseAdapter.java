...
public abstract class MyBaseAdapter<H, T> extends BaseAdapter {
    ...
    public MyBaseAdapter(Class<? extends H> clazz, Activity activity, int layoutId) {
        this.clazz = clazz;
        this.layoutId = layoutId;
        this.inflater = LayoutInflater.from(activity);
    }

    public MyBaseAdapter(Class<? extends H> clazz, Activity activity, int layoutId, List<T> data) {
        this(clazz, activity, layoutId);
        this.data = data;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            for (Field field : t) {
                ...
                if (assignableFrom) {
                    ...
                    try {
                        field.set(holder, convertView.findViewById(APP.app.getResources().getIdentifier(field.getName(), "id", APP.app.getPackageName())));
                    } catch (IllegalAccessException e) {
                        e.printStackTrace();
        ...
        initView(convertView, holder, position, getItem(position));
        return convertView;
    }
    ...
    public abstract void initView(View convertView, H holder, int position, T item);
