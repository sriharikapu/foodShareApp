...
import static com.fengnian.smallyellowo.foodie.R.id.ll;
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                getLoadStateImageView().setBackgroundResource(R.mipmap.load_succeed);
                break;
            ...
            default:
                ...
                getLoadStateImageView().setBackgroundResource(R.mipmap.load_failed);
                break;
        }
//        // 刷新结果停留1秒
...
//            RecyclerView.ViewHolder childViewHolder = ((RecyclerView) pullableView).getChildViewHolder(((RecyclerView) pullableView).getChildAt(0));
            RecyclerView.LayoutManager layoutManager = ((RecyclerView) pullableView).getLayoutManager();
            if (layoutManager instanceof LinearLayoutManager) {
                posi = ((LinearLayoutManager) layoutManager).findFirstVisibleItemPosition();
            } else {
                posi = ((StaggeredGridLayoutManager) layoutManager).findFirstVisibleItemPositions(null)[0];
            }
    ...
    public static PullToRefreshLayout supportPull(View lv, OnRefreshListener listener) {
        ...
        ViewGroup.LayoutParams layoutParams = (ViewGroup.LayoutParams) lv.getLayoutParams();
...
//						canPullUp = canUp;
    ...
    private void initView(Context context) {
        ...
        int[] ids = new int[]{R.mipmap.xxx01, R.mipmap.xxx03, R.mipmap.xxx05, R.mipmap.xxx07, R.mipmap.xxx09,
                R.mipmap.xxx11, R.mipmap.xxx13, R.mipmap.xxx15, R.mipmap.xxx17, R.mipmap.xxx19,
                R.mipmap.xxx22};
